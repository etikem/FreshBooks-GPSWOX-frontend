        ...
        <div className="px-4 py-3 border-b border-border flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-[240px] max-w-sm">
            ...
            <input
              ...
              className="w-full h-9 pl-9 pr-3 rounded-lg bg-bg-subtle border border-border hover:border-info/40 focus:border-info/60 focus:bg-bg-panel text-sm text-ink placeholder:text-ink-faint focus-ring transition-colors"
            />
          </div>
